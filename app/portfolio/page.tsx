...
export default function Page() {
  return (
    <div className="flex flex-col lg:flex-row items-center justify-around w-10/12 lg:w-4/5 mx-auto">
      ...
      <div className="h-auto flex flex-col self-center p-4 gap-2 border border-lines-1 md:w-96 mb-8 lg:mb-0">
        <h3 className="font-sans text-xl underline underline-offset-4">What do I do?</h3>
        <p className="text-base">
          ...
          <span className="text-accent-1">GSAP,</span> and more. Bringing
