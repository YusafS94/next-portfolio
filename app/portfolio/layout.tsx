...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <div
      className={`${fira_code.className} h-full md:h-screen flex-col md:overflow-hidden bg-slate-950`}
    >
      <div className="md:h-screen p-4">
        <div className="border border-lines-1 rounded-lg h-auto md:h-full bg-primary-2 text-secondary-1 flex flex-col">
